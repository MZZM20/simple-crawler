这是我的第一个爬虫项目.
今天早上起来,突然想把网页上的小说下载到本地来看,自然而然地我想到了爬虫.
...
就是你使用chrme浏览器时,右键然后点击的"查看网页源代码",此时你会发现再一串串代码中会夹杂着汉字,而这些字就是我们想要的东西.
...
我们可以从网页中提取出下一页的网址.
我以"神凑轻小说文库"网站为例,查看它的书籍的网页源代码.
你会发现<A href="66535.html"><img src="http://www.shencou.com/logo/x.gif" alt="下一章" /></A><span style="color: red;"></span> 这样一段源码
(可以CTRL+f搜索,将这段源码丢进去搜索框中),其中"66535.html"再加上"www.shencou.com/read/0/106/"就是下一页的网址了.

最后,是终止问题,即:书籍爬取完成后,或者是爬取过程中出现了异常,我们如何让程序正常退出呢?
